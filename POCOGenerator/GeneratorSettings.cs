...
namespace POCOGenerator
{
	...
	public interface POCO
	{
		...
		/// <summary>Gets or sets a value indicating that properties should be built without setters. This will also force a constructor to be built.</summary>
		bool ImmutableClass { get; set; }

		/// <summary>Gets or sets a value indicating that a static factory method will be added to instantiate new instances of this class.</summary>
		bool FactoryMethod { get; set; }
	}
	...
	internal sealed class GeneratorSettings : Settings, IDbIteratorSettings, ICloneable
	{
			...
			: this(new object())
		{
			...
			this.POCO.ImmutableClass = settings.POCO.ImmutableClass;
			this.POCO.FactoryMethod = settings.POCO.FactoryMethod;
			#endregion
		...
		private sealed class POCOSettings : POCO, IPOCOIteratorSettings
		{
			...
			public void Reset()
			{
				lock (lockObject)
				{
					...
					this.Tab = "    ";
					this.ImmutableClass = false;
					this.FactoryMethod = false;
				}
			}
			...
			private bool immutableClass;
			public bool ImmutableClass
			{
				get
				{
					lock (lockObject)
			...
			private bool factoryMethod;
			public bool FactoryMethod
			{
				get
				{
					lock (lockObject)
